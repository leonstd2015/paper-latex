...
(%中，而水平烟道和竖井烟道中仅布置有空气预热设备。所以锅炉可以分成两部分:炉膛内完成水/蒸汽吸热的boiler，和尾部烟道内 完成空气预热的APH。Feco), the back duct arranges a low-temperature second reheater (Ltsr) and back-duct economizer (Beco). The rear flue is equipped with an air preheater(APH).
...
Among the uncalculated components, the pips' amount increasing and work fluid mixing with parameters not match are the mainly reason why that party has a increment in exergy destruction rate.
