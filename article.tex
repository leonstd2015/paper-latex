...
% Nowadays ultra-supercritical (USC) power plants with large capacities and high parameters are considered to be feasible ways to save energy; as such, their usage has spread rapidly worldwide.
...
% Zhou et al.~\cite{Zhou2016Parametric} carried out a parametric analysis and system optimization of double-reheat ultra-supercritical power plants based on exergy analysis and economic analysis. 
% The results showed that reasonable reheat parameters and reheat stage numbers can improve the double-reheat system's performance.
% Xu et al.~\cite{Xu2015Optimum} investigated the thermal performance of the steam and water cycle with a double reheat after the installation of an additional outer steam cooler (AOC).
...
%虽然能够对蒸汽过热度进行利用，但是回热系统中换热器温差依旧很大。而利用锅炉烟气加热给水能够减少回热系统的换热温差

%对锅炉烟气余热的利用一直以来都是系统优化的重点。近年来部分学者提出的利用锅炉烟气加热给水方法提高系统效率，在该思路的指导下多种系统形式被提出：
...
现有研究往往关注与烟气余热温度与给水温度相匹配，并没有对锅炉中原有受热面进行优化。
为了能够对系统进行更加进一步的优化，用分析的方法被应用到热力系统优化中
...
而通过火用分析，热力系统中锅炉损失占总用损失的70%，而空预器的损失和整个回热系统的损失相当。
降低空预器的用损失是实现系统用效率提升的重点
通过实现空气、汽轮机抽汽、锅炉省煤器出口烟气和冷凝水温度相匹配，够降低低锅炉用损失，提高系统效率。
这一点对于二次再热系统尤为重要，
所以在二次再热机组上进行多工质温度匹配分析对机组节能更具有潜力。
