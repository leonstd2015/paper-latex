...
%  Over the past few decades, double-reheat USC units have received increasing attention due to their rapid development worldwide.
 ...
 为了能够提高热电厂的循环效率，研究人员不断对火电厂系统进行改进优化。
...
二次再热也已经作为一种有效提高系统效率的方式被深入研究并进行深入分析：
...
现有研究往往关注与烟气余热温度与给水温度相匹配，并没有对锅炉中原有受热面进行优化。而通过火用分析，热力系统中锅炉损失占总用损失的70%，空预器的损失和整个回热系统的损失相当。
通过实现空气、汽轮机抽汽、锅炉省煤器出口烟气和冷凝水温度相匹配，够降低低锅炉用损失，提高系统效率。
这一点对于二次再热系统尤为重要，随着近年来二次再热机组在世界范围研究和投入使用，其高效收到的广泛的认可，但是由于再热后抽汽的过热度提高，导致抽汽和给水温度不匹配造成的用损失也更加显著。
