...
The results of exergy analysis of the optimization system are presented in Table 5. It is found that the optimization system has an improvement in exergetic performance. The total exergy loss of the cascaded utilization system is 1096.52 MW, which is 32.28 MW lower than the original. The new system also brings the improvement from 46.98\% to 47.99\%. Results show that the exergy loss of boiler is 855.72 MW, leading to the increment of exergy efficiency by 0.18\%. In addition, there is almost no change of the exergy parameters of the steam turbines, generator and condenser. For the air heating system and regenerative system, great change happens compared with the formal system, and detailed analysis will be carried out next.
