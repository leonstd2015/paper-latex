...
\end{equation}
For different equipment under stable operating conditions, equation~\ref{equation:1}~\ref{equation:2} have different forms as shown in Table 5~\cite{}
...
\begin{table}
\caption{The exergy destruction rate and exergy efficiency equations for plant
components}
\label{table:exergy equation}
\centering{}%
\begin{tabular}{ccc}
\toprule {}
 & Exergy destruction rate & Exergy efficiency\tabularnewline
\midrule
Boiler &  & \tabularnewline
Pumps &  & \tabularnewline
Heaters &  & \tabularnewline
Turbine &  & \tabularnewline
Condenser &  & \tabularnewline
Cycle &  & \tabularnewline
\bottomrule
\end{tabular}
\end{table}
